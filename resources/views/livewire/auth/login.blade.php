        ...
        <div class="w-96">
            ...
            <form wire:submit="login">
                ...
                <div class="mb-5">
                    ...
                    <input wire:model="email" type="email" class="block w-full px-5 py-2 bg-white rounded-lg">
                    @error('email')
                ...
                <div x-data="{ login: false }" class="mt-7">
                    ...
                    <button type="submit" {{-- @click.prevent="login=true, $wire.login()" --}}
                        class="inline-block w-full py-3 font-bold uppercase rounded-full shadow-sm cursor-pointer px-7 text-primary-900 bg-primary-500 hover:bg-primary-600">Login</button>
                    {{-- </template> --}}
